...
function calculateAge() {
  ...
  // To Get Result
    ...
    let yr = (yrs.innerText =
      Math.round((difference / (1000 * 3600 * 24 * 365.25)) * 1000) / 1000 +
      " Years");
    let month = (months.innerText =
      Math.round((difference / (1000 * 3600 * 24 * 30.417)) * 100) / 100 +
      " Months");
    let day = (days.innerText = difference / 86400000 + " Days");
    let week = (weeks.innerText =
      Math.round((difference / (1000 * 3600 * 24 * 7)) * 100) / 100 + " Weeks");
